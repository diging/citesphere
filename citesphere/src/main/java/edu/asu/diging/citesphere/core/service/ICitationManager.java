...
public interface ICitationManager {
    ...
    CitationResults getGroupItems(IUser user, String groupId, String collectionId, int page, String sortBy, String conceptTag) throws GroupDoesNotExistException;
