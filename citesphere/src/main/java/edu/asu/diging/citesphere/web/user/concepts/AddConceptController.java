...
public class AddConceptController {
    ...
    public String show(Model model, Principal principal) {
        ...
        model.addAttribute("types",
                typeManager.getAllTypes(userManager.findByUsername(principal.getName())));
    ...
    public String post(CitationConceptForm form, Model model, Principal principal) {
        ...
        if (form.getName() != null && !form.getName().trim().isEmpty() && form.getUri() != null
                && !form.getUri().trim().isEmpty()
