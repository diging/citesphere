...
public class UploadItemFileController {
    ...
    public ResponseEntity<String> uploadFile(Principal principal, @PathVariable String zoteroGroupId, @PathVariable String itemId,
        ...
        List<IUploadFileJob> jobs;
        try {
            jobs = jobManager.createUploadJob(user, files, fileBytes, zoteroGroupId, itemId);
