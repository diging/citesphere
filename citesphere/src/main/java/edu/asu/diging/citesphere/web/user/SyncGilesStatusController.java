...
public class SyncGilesStatusController {
    ...
    @RequestMapping(value="/auth/group/{zoteroGroupId}/items/{itemId}/sync/giles/{fileId}") 
    public String getGilesstatus(Authentication authentication, Model model, @PathVariable("zoteroGroupId") String zoteroGroupId, 
            @PathVariable("itemId") String itemId, @PathVariable String fileId, 
        ...
        uploadChecker.checkFileUploadStatus(itemId, (IUser)authentication.getPrincipal(), fileId);
