			...
			<div class="modal-body">
				...
				<div role="tabpanel">
					...
					<ul class="nav nav-tabs" role="tablist">
						...
						<li role="presentation"><a
							href="#importedAuthoritiesTabContent" aria-controls="browseTab"
							role="tab" data-toggle="tab">Authorities imported from
								Conceptpower</a></li>
					</ul>
					<!-- Tab panes -->
					...
					<div class="tab-content">
						...
						<div role="tabpanel" class="tab-pane"
							id="importedAuthoritiesTabContent">

							<ul id="importedAuthority-pagination-top" class="pagination-sm"></ul>

							<div id="importedAuthoritiesError" class="text-warning"
								style="display: none">
