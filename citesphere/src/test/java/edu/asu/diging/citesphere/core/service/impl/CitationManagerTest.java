...
public class CitationManagerTest {
    ...
    public void test_getCitationVersions_inDb() throws AccessForbiddenException, GroupDoesNotExistException {
        ...
        Mockito.when(citationVersionsDao.getVersions(GROUP_ID, EXISTING_ID, PAGE, PAGESIZE)).thenReturn(citationVersions);
    ...
    public void test_getCitationVersions_doesNotExist() throws AccessForbiddenException, GroupDoesNotExistException {
        List<CitationVersion> actualEmpty = managerToTest.getCitationVersions(user, GROUP_ID, EXISTING_ID, PAGE, PAGESIZE);
    ...
    public void test_getCitationVersion_exists() throws AccessForbiddenException, GroupDoesNotExistException {
        Mockito.when(managerToTest.getCitationVersion(user, GROUP_ID, EXISTING_ID, CITATION_VERSION_1)).thenReturn(citation1);
        Mockito.when(managerToTest.getCitationVersion(user, GROUP_ID, EXISTING_ID, CITATION_VERSION_2)).thenReturn(citation2);
    ...
    public void test_getPrevAndNextCitation_prevAndNextOnCurrentPage() throws GroupDoesNotExistException, ZoteroHttpStatusException {
        ...
        Mockito.doReturn(citations).when(citationDao).findCitations(GROUP_ID, (page-1)*50, 50, false);
    ...
    public void test_getPrevAndNextCitation_prevOnCurrentPageAndNextOnNextPage() throws GroupDoesNotExistException, ZoteroHttpStatusException {
        ...
        Mockito.doReturn(citations).when(citationDao).findCitations(GROUP_ID, (page-1)*9, 9, false);
        Mockito.doReturn(citationsPage2).when(citationDao).findCitations(GROUP_ID, (page)*9, 9, false);
    ...
    public void test_getPrevAndNextCitation_prevOnPrevPageAndNextOnCurrentPage() throws GroupDoesNotExistException, ZoteroHttpStatusException {
        ...
        Mockito.doReturn(citations).when(citationDao).findCitations(GROUP_ID, (page-2)*9, 9, false);
        Mockito.doReturn(citationsPage2).when(citationDao).findCitations(GROUP_ID, (page-1)*9, 9, false);
        CitationPage actualResult= managerToTest.getPrevAndNextCitation(user, GROUP_ID, "", page, sortBy, index);
    ...
    public void test_getPrevAndNextCitation_noPrevAndNext() throws GroupDoesNotExistException, ZoteroHttpStatusException {
        ...
        Mockito.when(citationDao.findCitations(GROUP_ID, page-1, 0, false)).thenReturn(new ArrayList<>());
        CitationPage actualResult= managerToTest.getPrevAndNextCitation(user, GROUP_ID, "", page, sortBy, index);
        Assert.assertNull(actualResult.getNext());
